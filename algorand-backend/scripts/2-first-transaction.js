...
let myaccount = algosdk.mnemonicToSecretKey("oil engine possible movie food garden mask weird absent barrel effort creek sick night library enable position account solution audit illegal cycle snow ability glow"); 
